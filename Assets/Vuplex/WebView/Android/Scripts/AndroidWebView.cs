...
namespace Vuplex.WebView {
    ...
    public class AndroidWebView : BaseWebView,
        ...
        /// </code>
        /// </example>
        public static void SetNativeViewGroup(AndroidJavaObject viewGroup) => _callStaticMethod("setNativeViewGroup", viewGroup);
        ...
        /// </code>
        /// </example>
        public static void SetRemoteDebuggingEnabled(bool enabled) => _callStaticMethod("setRemoteDebuggingEnabled", enabled);
